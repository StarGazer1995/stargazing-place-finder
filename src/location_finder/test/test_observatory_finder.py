        ...
        expected_result = [
            {
                ...
                "lat": 39.9042,
                "lon": 116.4074,
                "tags": {"name": "测试天文台", "man_made": "observatory"},
            }
        ]
        ...
        mock_observatories.return_value = [
            {
                ...
                "lat": 39.9042,
                "lon": 116.4074,
                "tags": {"name": "测试天文台", "man_made": "observatory", "description": "这是一个测试天文台"},
            }
        ]

        # 模拟城镇数据
        mock_towns.return_value = [{"type": "node", "lat": 39.9000, "lon": 116.4000, "tags": {"name": "测试城镇"}}]
...
class TestObservatoryIntegration(unittest.TestCase):
    ...
    def test_real_observatory_search(self):
        ...
        try:
            result = self.finder.find_observatories_in_area(bbox=small_bbox, max_observatories=5)
