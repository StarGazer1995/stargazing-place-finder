...
from stargazing_place_finder import StarGazingPlaceFinder, OverpassCache
...
class TestStarGazingPlaceFinderCache(unittest.TestCase):
    ...
    @patch('stargazing_place_finder.get_cache_dir')
    ...
    @patch('stargazing_place_finder.get_cache_dir')
    @patch('stargazing_place_finder.StarGazingPlaceFinder._make_overpass_request')
