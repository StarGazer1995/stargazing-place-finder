...
class TestObservatoryFinder(unittest.TestCase):
    ...
    @patch('src.mountain_peak_finder.MountainPeakFinder.get_observatories_from_overpass')
    @patch('src.mountain_peak_finder.MountainPeakFinder.get_towns_from_overpass')
    @patch('src.mountain_peak_finder.MountainPeakFinder.get_elevation_from_api')
